...
{ 
  echo "<tr><td>".$row["id"]."</td><td>".$row["terminal"]."</td><td>".$row["city"]."</td><td>".$row["status"]."</td><td style='padding-right:3%;'><button type='button' class='btn btn-success'>Edit</button><button type='button' class='btn btn-danger'>Delete</button></td> </tr><br>";
}
echo "</table>"; 
}
else
...
<div class="vertical-menu" >
  ...
  <a href="terminal.php" class="glyphicon glyphicon-cog" style="font-size: 90%; padding-left: 20%;"> Expense Type</a>
...
<br>
<br>
<div style="background-color: #229954"><h4 class="glyphicon glyphicon-list"  style="color: white;padding-left: 3%;"> Terminals</h4></div><br>
...
echo "<select class='form-control' id='sel1' name='city'>";
...
<div class="col-md-9">
<br>
<div style="background-color: #229954"><h2 class="glyphicon glyphicon-globe"  style="color: white;padding-left: 2%;padding-bottom: 1%;"> View Terminal </h2></div>
<?php
myterminaldisplay();
